...
bufferSize = 64 * 1024
password = "iaSnTy1dXDNP8I6xyEqe1lcAtm12BvjeaDzfBYtdrNQ" #any string size you want
...
#directory for test  but you can put any directory you want
dir_path = 'C:' + '/' + 'Users' + '/' + os.getlogin() + '/' + 'Pictures' +'/' + 'tes'
